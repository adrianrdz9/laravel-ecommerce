                                            ...
                                            <td valign="top">
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Recibo de tu compra en esta súper tienda</h1>

                                                                <strong>!Hola¡ {{$order->email}}</strong>
                                                                Te enviamos el recibo de tu compra
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="bodyContent" valign="top">
                                                            <div mc:edit="std_content01">
                                                                Direccion a la que enviaremos tu producto:
                                                                <br>
                                                                <br>
                                                                {{$order->address()}}
                                                                <br>
                                                                ...
                                                                Estado: {{$order->state}}
                                                                <br>
                                                                País: {{$order->country_code}}
                                                                <br>
                                                                C.P.: {{$order->postal_code}}
                                                                <br>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="bodyContent" valign="top">
                                                            <div mc:edit="std_content01">
                                                                Si algun dato es erroneo mandanos un correo a
                                                                <a href="ayuda@asd.com">ayuda@asd.com</a>
                                                                <br>
                                                                <br>
                                                                Tu id de compra se te sera solicitado:
                                                                <br>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{url('/compras/'.$order->shoppingCartId())}}" target="_blank">Ver mas informacion de tu pedido</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2016 supertienda, All rights reserved.</em>
																<br />
																<strong>Our mailing address is:</strong>
																<br />
																adrian.rodriguez7109@gmail.com
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
